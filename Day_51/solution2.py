...
class InternetSpeedTwitterBot():
    ...
    def get_internet_speed(self):
        ...
        consent_button = self.driver.find_element_by_class_name("evidon-barrier-acceptbutton")
    ...
    def tweet_provider(self):
        ...
        time.sleep(3)
        try:
            self.driver.find_element_by_name('session[username_or_email]').send_keys(EMAIL)
        ...
        try:
            self.driver.find_element_by_xpath(
                '//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div[1]/div/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div[1]/div/div/div/div/div/div/div/div/div/div[1]/div/div/div/div[2]/div/div/div/div').send_keys(
                self.message)
            self.driver.find_element_by_xpath(
...
bot = InternetSpeedTwitterBot(400, 200)
